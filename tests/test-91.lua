...
mt.echo("*** begin test-91 - Missing Message-ID, but from domain in exclude_fromheader_domains (case-insensitivity-test)")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-91-config.yaml")
mt.sleep(2)
