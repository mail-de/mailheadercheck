...
mt.echo("*** begin test-93 - Missing Message-ID, but from domain in exclude_envelopefrom_domains (MAIL FROM has <> chars) ")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-93-config.yaml")
mt.sleep(2)
