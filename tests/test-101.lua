...
mt.echo("*** begin test-101 - From header with name but no email address (REJECT)")
...
-- send headers: From header contains a display name but no email address
if mt.header(conn, "From", "John Doe") ~= nil then
