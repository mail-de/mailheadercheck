...
mt.echo("*** begin test-82 - Missing Message-ID, but from domain in exclude_envelopefrom_domains")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-82-config.yaml")
mt.sleep(2)
