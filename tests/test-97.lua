...
mt.echo("*** begin test-97 - Missing Message-ID, Envelope-From NOT in exclude_envelopefrom_addresses (REJECT)")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-97-config.yaml")
mt.sleep(2)
