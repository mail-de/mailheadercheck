...
mt.echo("*** begin test-99 - Missing Message-ID, SASL username NOT in exclude_sasl_usernames (REJECT)")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-99-config.yaml")
