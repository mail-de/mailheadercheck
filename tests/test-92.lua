...
mt.echo("*** begin test-92 - Missing Message-ID, but from domain in exclude_envelopefrom_domains (case-insensitivity-test)")

-- start the filter
mt.startfilter("./mailheadercheck", "--config", "tests/test-92-config.yaml")
mt.sleep(2)
